...
namespace iteraBus.Repositorio.Migrations
{
    ...
    [Migration("20250403201142_FavoritarRota")]
    partial class FavoritarRota
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RotaUsuario", b =>
                {
                    b.Property<int>("RotasFavoritasId")
                        .HasColumnType("int");

                    b.Property<int>("UsuariosQueFavoritaramId")
                        .HasColumnType("int");

                    b.HasKey("RotasFavoritasId", "UsuariosQueFavoritaramId");

                    b.HasIndex("UsuariosQueFavoritaramId");

                    b.ToTable("UsuarioRotasFavoritas", (string)null);
                });
            ...
            modelBuilder.Entity("RotaUsuario", b =>
                {
                    b.HasOne("iteraBus.Dominio.Entidades.Rota", null)
                        .WithMany()
                        .HasForeignKey("RotasFavoritasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("iteraBus.Dominio.Entidades.Usuario", null)
                        .WithMany()
